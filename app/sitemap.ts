...
const seoRoutes: Array<{ path: string; priority: number; freq: MetadataRoute.Sitemap[number]["changeFrequency"] }> = [
  ...
  { path: "/it/noleggio-scooter-ischia-porto", priority: 0.85, freq: "monthly" },
  { path: "/it/noleggio-auto-ischia", priority: 0.85, freq: "monthly" },
  { path: "/en/car-rental-ischia", priority: 0.85, freq: "monthly" },
  { path: "/it/noleggio-auto-ischia-senza-carta-di-credito", priority: 0.8, freq: "monthly" },
  ...
  { path: "/en/where-to-stay-in-ischia-without-a-car", priority: 0.85, freq: "monthly" },
