...
export const categoryLandings: Record<Locale, Record<CategoryLandingKey, CategoryLandingContent>> = {
  it: {
    auto: {
      ...
      h1: "Noleggio auto a Ischia: più spazio per il tuo soggiorno",
      ...
      subtitle: "Indicaci date, zona di soggiorno e numero di persone: controlliamo rapidamente le auto disponibili e ti inviamo prezzo e condizioni.",
    ...
    ebike: {
      ...
      h1: "Noleggio e-bike a Ischia: scopri l'isola in bici",
      ...
      subtitle: "Indicaci date e zona di soggiorno: verifichiamo rapidamente disponibilità, prezzo e punto di ritiro o consegna dell'e-bike più adatta.",
    ...
    barca: {
      ...
      h1: "Noleggio barche a Ischia: la costa vista dal mare",
  ...
  en: {
    auto: {
      ...
      h1: "Car Rental in Ischia: More Space for Your Stay",
      ...
      subtitle: "Share your dates, area of stay and number of guests: we quickly check available cars and send you price and conditions.",
    ...
    ebike: {
      ...
      h1: "E-Bike Rental in Ischia: Discover the Island by Bike",
      ...
      subtitle: "Share your dates and area of stay: we quickly check availability, price and pickup or delivery for the right e-bike.",
    ...
    barca: {
      ...
      h1: "Boat Rental in Ischia: See the Coast from the Sea",
