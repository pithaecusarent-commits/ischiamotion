...
export const categoryLandings: Record<Locale, Record<CategoryLandingKey, CategoryLandingContent>> = {
  it: {
    auto: {
      ...
      metaTitle: "Noleggio Auto Ischia | Auto comode per scoprire l’isola",
    ...
    gommone: {
      ...
      metaTitle: "Noleggio Gommoni Ischia | Vivi il mare in libertà",
    ...
    beach_club: {
      ...
      metaTitle: "Beach Club Ischia | Lettini, ombrelloni e servizi mare",
