...
export const categoryLandings: Record<Locale, Record<CategoryLandingKey, CategoryLandingContent>> = {
  it: {
    auto: {
      ...
      metaTitle: "Noleggio Auto Ischia: Ritiro e Disponibilità | IschiaMotion",
      metaDescription: "Noleggio auto a Ischia tramite partner locali selezionati. Verifica disponibilità, ritiro al porto e consegna dove prevista.",
      primaryKeyword: "noleggio auto Ischia",
      eyebrow: "Auto a Ischia",
      description: "Richiedi disponibilità per il noleggio auto a Ischia tramite partner locali selezionati. Un’auto a noleggio a Ischia è una soluzione comoda se arrivi con bagagli o viaggi in famiglia; l’autonoleggio viene verificato tra porto, hotel e comuni dell'isola.",
    ...
    ebike: {
      ...
      metaTitle: "Noleggio E-Bike Ischia: Bici e Percorsi | IschiaMotion",
      metaDescription: "Noleggio e-bike a Ischia tramite partner selezionati. Verifica bici elettriche disponibili, ritiro, autonomia e percorsi consigliati.",
      primaryKeyword: "noleggio e-bike Ischia",
      eyebrow: "E-bike a Ischia",
      description: "Il noleggio e-bike a Ischia è ideale per spostamenti leggeri tra borghi, lungomare e percorsi panoramici. Il noleggio di bici elettriche a Ischia aiuta ad affrontare salite e distanze con più facilità; la disponibilità viene verificata tramite partner locali selezionati.",
    ...
    gommone: {
      ...
      metaTitle: "Noleggio Gommoni Ischia: Requisiti e Ritiro | IschiaMotion",
      metaDescription: "Noleggio gommoni a Ischia tramite partner locali selezionati. Verifica disponibilità, patente, punto nautico e condizioni meteo.",
      primaryKeyword: "noleggio gommoni Ischia",
      eyebrow: "Gommoni a Ischia",
      description: "Richiedi disponibilità per il noleggio gommoni a Ischia tramite partner locali selezionati. Se cerchi un gommone senza patente a Ischia, requisiti e motorizzazione vengono verificati prima della conferma, insieme a ritiro e condizioni meteo-marine.",
    ...
    barca: {
      ...
      metaTitle: "Noleggio Barche Ischia: Disponibilità | IschiaMotion",
      metaDescription: "Noleggio barche a Ischia tramite partner selezionati. Verifica disponibilità, punto di partenza, requisiti e condizioni meteo.",
      primaryKeyword: "noleggio barche Ischia",
      eyebrow: "Barche a Ischia",
      description: "Richiedi disponibilità per il noleggio barche a Ischia tramite partner locali selezionati. L’affitto di una barca a Ischia permette di vivere costa e calette dal mare, con punto di partenza e condizioni verificati prima della conferma.",
    ...
    beach_club: {
      ...
      metaTitle: "Beach Club Ischia: Lettini e Servizi | IschiaMotion",
  ...
  en: {
    auto: {
      ...
      metaTitle: "Car Rental Ischia: Pickup and Availability | IschiaMotion",
      metaDescription: "Car rental in Ischia through selected local partners. Check availability, port pickup, requirements and hotel delivery where offered.",
      primaryKeyword: "car rental Ischia",
      eyebrow: "Cars in Ischia",
      description: "Request car rental in Ischia through selected local partners. Car hire in Ischia is practical when arriving with luggage, travelling with family or moving between ports, hotels and island towns.",
    ...
    ebike: {
      ...
      metaTitle: "E-bike Rental Ischia: Routes and Pickup | IschiaMotion",
    ...
    gommone: {
      ...
      metaTitle: "Rubber Dinghy Rental Ischia: Coast | IschiaMotion",
    ...
    beach_club: {
      ...
      metaTitle: "Ischia Beach Clubs: Sunbeds and Services | IschiaMotion",
