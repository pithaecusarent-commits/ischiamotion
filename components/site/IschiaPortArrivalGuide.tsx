...
const content: Record<Locale, Content> = {
  it: {
    ...
    whatsappMsg: "Ciao IschiaMotion, sto per arrivare a Ischia Porto.\n\nArrivo il [data], soggiorno in zona [zona/hotel] e sto valutando [scooter/auto/e-bike/taxi].\n\nPotete aiutarmi a capire la soluzione più comoda per i miei spostamenti?",
  ...
  en: {
    ...
    whatsappMsg: "Hi IschiaMotion, I’m about to arrive at Ischia Porto.\n\nI arrive on [date], I’m staying in [area/hotel], and I’m considering [scooter/car/e-bike/taxi].\n\nCan you help me understand the most convenient solution for my plans?",
