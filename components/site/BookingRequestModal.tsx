...
const copy = {
  it: {
    ...
    subtitle: "Lascia i dettagli essenziali: verifichiamo subito disponibilità, prezzo e condizioni con i partner locali e ti rispondiamo in pochi minuti.",
    firstName: "Nome",
    lastName: "Cognome",
    email: "Email",
  ...
  en: {
    ...
    subtitle: "Share the key details: we instantly check availability, price and conditions with local partners and reply within minutes.",
