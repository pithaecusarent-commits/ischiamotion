...
const content: Record<Locale, Content> = {
  it: {
    ...
    whatsappMsg: "Ciao IschiaMotion, sto pianificando cosa vedere a Ischia senza auto.\n\nArrivo il [data], soggiorno in zona [zona/hotel] e sto valutando [scooter/e-bike/taxi/barca].\n\nPotete aiutarmi a capire la soluzione più comoda per il mio soggiorno?",
  ...
  en: {
    ...
    whatsappMsg: "Hi IschiaMotion, I’m planning what to see in Ischia without a car.\n\nI arrive on [date], I’m staying in [area/hotel], and I’m considering [scooter/e-bike/taxi/boat].\n\nCan you help me understand the most convenient solution for my stay?",
