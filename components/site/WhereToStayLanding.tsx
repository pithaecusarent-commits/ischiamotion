...
const content: Record<Locale, PageContent> = {
  it: {
    ...
    whatsappMsg: "Ciao IschiaMotion, vorrei un consiglio per scegliere dove soggiornare e come muovermi a Ischia.\n\nArrivo il [data], sto valutando la zona [zona/hotel] e vorrei capire se conviene scooter, auto, e-bike o taxi.\n\nPotete aiutarmi a scegliere la soluzione più comoda?",
  ...
  en: {
    ...
    whatsappMsg: "Hi IschiaMotion, I’d like some advice on where to stay and how to get around Ischia.\n\nI arrive on [date], I’m considering [area/hotel], and I’d like to understand whether a scooter, car, e-bike or taxi makes sense.\n\nCan you help me choose the most convenient option?",
